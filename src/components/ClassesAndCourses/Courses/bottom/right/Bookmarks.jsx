...
const removeBookmark = (id)=> {
  console.log(id)
  return bookmarkData.splice(id, 1);
}
...
// console.log(cName);
  ...
  return (
    <div className='bg-black/20 text-white rounded-[10px] borders backdrop-blur-md shadow-m h-100 hover:scale-105 transition-all'>
