...
// console.log(cName);
  ...
  return (
    <div className='bg-black/20 text-white rounded-[10px] borders backdrop-blur-md shadow-m min-h-50 max-h-100 hover:scale-105 transition-all overflow-y-auto bmkDiv max-lg:w-[50%]'>
