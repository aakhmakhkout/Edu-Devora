  ...
  return (
    <div className="flex justify-around min-h-[40%]  items-center max-lg:pt-25 max-lg:pb-5">
      <div className="w-[full] flex flex-col gap-5 px-10 ">
        <h1 className="text-6xl font-bold max-lg:text-4xl max-emd:text-2xl">Explore Our <span className="text-[#f69d11] border-b-5 border-b-[#541f9f] rounded-b-md">Classes</span></h1>
