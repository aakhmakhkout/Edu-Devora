   ...
   <div className='flex justify-center min-h-150'>
      <div className='flex w-[90%] h-full justify-between max-lg:relative'>
        ...
        <div className='flex flex-col gap-7 max-lg:w-[60%]'>
            <h1 className='text-6xl font-bold max-lg:text-4xl'><span className='border-b-4 border-b-[#6464dc] rounded-b-sm'>About</span> <span className='text-[#f69d11]'>Edu-Devora</span></h1>
